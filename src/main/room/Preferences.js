...
Javatari.preferences.defaults = {
    ...
    KP0BUT2  : -1,//jt.Keys.VK_DELETE.c,
    KP1LEFT  : jt.Keys.VK_A.c,
    KP1UP    : jt.Keys.VK_W.c,
    KP1RIGHT : jt.Keys.VK_D.c,
    KP1DOWN  : jt.Keys.VK_S.c,
    KP1BUT   : jt.Keys.VK_Q.c,
    KP1BUT2  : -1,//jt.Keys.VK_PERIOD.c,
